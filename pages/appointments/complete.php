...
?>
<p style="font-size:19px;font-weight:800px;"> <strong> <?= $apt_type ?> </strong></p>
...
<div class="row">
            ...
            <div class="card card-primary" style="margin-left:30px; width: 480px; font-size:12px" >   
                    <div class="card-body">	
                    <div class="form-group">
                       ...
                       <div class="form-group">
                            ...
                            <textarea class="form-control" id ="setaptfind" rows="4" placeholder="Enter findings..." style="font-size:11px"></textarea>  
                             </div>
                        <div class="form-group">
                            <label>Diagnosis: </label>
                            <textarea class="form-control" id ="setaptdiag" rows="3" placeholder="Enter diagnosis..." style="font-size:11px"></textarea>  
                             </div>
                        <div class="form-group">
                            <label>Medication/s: </label>
                            <textarea class="form-control" id ="setaptmed" rows="2" placeholder="Enter medications..." style="font-size:11px"></textarea>  
                             </div>
                      <div class="form-group">
                            <label>Vaccination: </label>
                            <textarea class="form-control" id ="setaptvac" rows="2" placeholder="Enter vaccination..." style="font-size:11px"></textarea>  
                             </div>
                      <div class="form-group">
                            <label>Other information: </label>
                            <textarea class="form-control" id ="setaptinfo" rows="3" placeholder="Enter other information..." style="font-size:11px"></textarea>  
                             </div>
                                  </div>
                            </div>
